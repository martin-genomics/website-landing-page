...
import { openBlock as l, createElementBlock as f, createElementVNode as H, ref as p, watchEffect as W, defineComponent as ht, computed as k, onMounted as kt, onUnmounted as Ot, normalizeClass as F, normalizeStyle as Et, unref as it, createVNode as V, createCommentVNode as N, createBlock as X, resolveDynamicComponent as st, mergeProps as rt, Fragment as R, renderSlot as P, normalizeProps as Tt, createTextVNode as Bt, toDisplayString as nt, renderList as ft, useAttrs as Dt, nextTick as Lt, watch as $t, withCtx as K } from "vue";
function Ht(r) {
...
class Yt {
  constructor() {
    ...
    x(this, "create", (o) => {
      var b;
      const { message: e, ...a } = o, m = typeof o.id == "number" || o.id && ((b = o.id) == null ? void 0 : b.length) > 0 ? o.id : pt++, u = this.toasts.find((d) => d.id === m), h = o.dismissible === void 0 ? !0 : o.dismissible;
      return u ? this.toasts = this.toasts.map((d) => d.id === m ? (this.publish({ ...d, ...o, id: m, title: e }), {
        ...
        dismissible: h,
        title: e
      }) : d) : this.addToast({ title: e, ...a, dismissible: h, id: m }), m;
    });
    ...
    x(this, "promise", (o, e) => {
      ...
      let u = a !== void 0;
      return m.then((h) => {
        if (h && // @ts-expect-error
        typeof h.ok == "boolean" && // @ts-expect-error
        !h.ok) {
          u = !1;
          ...
          u = !1;
          const b = typeof e.success == "function" ? e.success(h) : e.success, d = typeof e.description == "function" ? (
            // @ts-expect-error
            e.description(h)
          ) : e.description;
        ...
        if (e.error !== void 0) {
          u = !1;
          const b = typeof e.error == "function" ? e.error(h) : e.error, d = typeof e.description == "function" ? (
            // @ts-expect-error
            e.description(h)
          ) : e.description;
          this.create({ id: a, type: "error", message: b, description: d });
        ...
        var h;
        u && (this.dismiss(a), a = void 0), (h = e.finally) == null || h.call(e);
      }), a;
    });
...
function jt(r, o) {
  return l(), f("svg", Wt, _t);
}
const Kt = /* @__PURE__ */ G(Rt, [["render", jt]]), Xt = () => {
  const r = p(!1);
  return W(() => {
    const o = () => {
  ...
  key: 0,
  "data-icon": ""
}, Jt = { "data-content": "" }, Qt = 4e3, te = 14, ee = 20, ae = 200, oe = /* @__PURE__ */ ht({
  __name: "Toast",
  props: {
    toast: {},
    toasts: {},
  ...
  setup(r, { emit: o }) {
    const e = o, a = r, m = p(!1), u = p(!1), h = p(!1), b = p(!1), d = p(0), O = p(0);
    let D = 0;
    const E = p(null), z = k(() => a.index === 0), A = k(() => a.index + 1 <= a.visibleToasts), T = k(() => a.toast.type), _ = k(() => a.toast.dismissible !== !1), lt = k(() => {
      var t, i, y, S, w, g, M;
      return a.cn(
        ...
        (M = (g = a.toast) == null ? void 0 : g.classes) == null ? void 0 : M[a.toast.type || "default"]
      );
    ...
    ), n = p(0), c = p(0), B = p(s.value), $ = p(0), v = p(null), L = k(() => a.position.split("-")), q = k(() => L.value[0]), J = k(() => L.value[1]), Q = typeof a.toast.title != "string", tt = typeof a.toast.description != "string", et = k(() => a.heights.reduce((t, i, y) => y >= Z.value ? t : t + i.height, 0)), at = Xt(), ot = k(() => a.toast.invert || a.invert), U = k(() => T.value === "loading");
    kt(() => {
      if (!m.value)
        return;
      ...
      let S;
      a.heights.find(
        (g) => g.toastId === a.toast.id
      ) ? S = a.heights.map(
        (g) => g.toastId === a.toast.id ? { ...g, height: y } : g
      ) : S = [
        {
          toastId: a.toast.id,
          height: y,
    ...
    const I = () => {
      ...
      U.value || !_.value || (D = Date.now(), d.value = c.value, t.target.setPointerCapture(t.pointerId), t.target.tagName !== "BUTTON" && (h.value = !0, v.value = { x: t.clientX, y: t.clientY }));
    }, Pt = (t) => {
      var w, g, M, Y;
      if (b.value)
        return;
      ...
      ), y = Date.now() - D || 50, S = Math.abs(i) / y;
      if (Math.abs(i) >= ee || S > 0.11) {
        d.value = c.value, (M = (g = a.toast).onDismiss) == null || M.call(g, a.toast), I(), b.value = !0;
        return;
      }
      (Y = E.value) == null || Y.style.setProperty("--swipe-amount", "0px"), h.value = !1;
    }, zt = (t) => {
      var Y;
      if (!v.value)
        return;
      const i = t.clientY - v.value.y, y = t.clientX - v.value.x, w = (L.value[0] === "top" ? Math.min : Math.max)(0, i), g = t.pointerType === "touch" ? 10 : 2;
      Math.abs(w) > g ? (Y = E.value) == null || Y.style.setProperty("--swipe-amount", `${i}px`) : Math.abs(y) > g && (v.value = null);
    };
    return W(() => {
      ...
      const y = () => {
        ...
        n.value = Date.now(), i = setTimeout(() => {
          var w, g;
          (g = (w = a.toast).onAutoClose) == null || g.call(w, a.toast), I();
        }, B.value);
      };
      ...
      var y, S, w, g, M, Y, gt, mt, vt, yt, bt, wt;
      return l(), f("li", {
        ...
        ct.value && !t.toast.component ? (l(), f("button", {
          key: 0,
          "aria-label": t.closeButtonAriaLabel || "Close toast",
          "data-disabled": U.value,
          "data-close-button": "",
          class: F(t.cn((S = t.classes) == null ? void 0 : S.closeButton, (g = (w = t.toast) == null ? void 0 : w.classes) == null ? void 0 : g.closeButton)),
          onClick: ut
        }, [
          V(Kt)
        ], 10, Zt)) : N("", !0),
        t.toast.component ? (l(), X(st(t.toast.component), rt({ key: 1 }, t.toast.componentProps, { onCloseToast: I }), null, 16)) : (l(), f(R, { key: 2 }, [
          T.value !== "default" || t.toast.icon || t.toast.promise ? (l(), f("div", qt, [
            (t.toast.promise || T.value === "loading") && !t.toast.icon ? P(t.$slots, "loading-icon", { key: 0 }) : N("", !0),
            t.toast.icon ? (l(), X(st(t.toast.icon), { key: 1 })) : (l(), f(R, { key: 2 }, [
          ...
          H("div", Jt, [
            H("div", {
              ...
              Q ? (l(), X(st(t.toast.title), Tt(rt({ key: 0 }, t.toast.componentProps)), null, 16)) : (l(), f(R, { key: 1 }, [
            ...
            t.toast.description ? (l(), f("div", {
              ...
              class: F(
                t.cn(
                  ...
                  (gt = t.classes) == null ? void 0 : gt.description,
                  (mt = t.toast.classes) == null ? void 0 : mt.description
                )
              )
            }, [
              tt ? (l(), X(st(t.toast.description), Tt(rt({ key: 0 }, t.toast.componentProps)), null, 16)) : (l(), f(R, { key: 1 }, [
...
}), se = ["data-visible"], ne = { class: "sonner-spinner" }, re = /* @__PURE__ */ ht({
  __name: "Loader",
  props: {
  ...
  setup(r) {
    ...
    return (e, a) => (l(), f("div", {
      ...
      H("div", ne, [
        (l(!0), f(R, null, ft(it(o), (m) => (l(), f("div", {
          key: `spinner-bar-${m}`,
...
function ue(r, o) {
  return l(), f("svg", le, ce);
}
const fe = /* @__PURE__ */ G(ie, [["render", ue]]), pe = {}, he = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 20 20",
  fill: "currentColor",
  height: "20",
...
function Ie(r, o) {
  return l(), f("svg", Se, Ee);
}
const Pe = /* @__PURE__ */ G($e, [["render", Ie]]), ze = ["aria-label"], Ae = ["dir", "data-theme", "data-rich-colors", "data-y-position", "data-x-position"], Me = 3, St = "32px", He = 4e3, Oe = 356, Ct = 14, De = typeof window < "u" && typeof document < "u", Le = /* @__PURE__ */ ht({
  name: "Toaster",
  inheritAttrs: !1,
  __name: "Toaster",
  props: {
  ...
  setup(r) {
    ...
    ), E = k(() => a.cn || o), z = p(null), A = p(null), T = p(!1), _ = a.hotkey.join("+").replace(/Key/g, "").replace(/Digit/g, "");
    function lt(s) {
      u.value = u.value.filter(({ id: n }) => n !== s.id);
    }
    const dt = (s) => {
      var n, c;
      T.value && !((c = (n = s.currentTarget) == null ? void 0 : n.contains) != null && c.call(n, s.relatedTarget)) && (T.value = !1, A.value && (A.value.focus({ preventScroll: !0 }), A.value = null));
    }, Z = (s) => {
    ...
    return W((s) => {
      ...
      function n(c) {
        ...
        c.code === "Escape" && v && (d.value = !1);
      }
      De && (document.addEventListener("keydown", n), s(() => {
        document.removeEventListener("keydown", n);
      }));
    }), (s, n) => (l(), f("section", {
      "aria-label": `${s.containerAriaLabel} ${it(_)}`,
      tabIndex: -1
    }, [
      (l(!0), f(R, null, ft(h.value, (c, B) => {
        var $;
        return l(), f("ol", rt({
          key: c,
          ref_for: !0,
          ...
          (l(!0), f(R, null, ft(u.value.filter(
            (v) => !v.position && B === 0 || v.position === c
          ), (v, L) => {
